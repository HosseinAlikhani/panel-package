                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form name="general-info" class="section general-info"
                                  method="POST" action="{{ route('update.user', $user->id) }}"
                            >
                                @csrf
                                <div class="info">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" id="fname" name="fname" placeholder="{{ __('Panel-Lang::trans.FirstName') }}" value="{{ $user->fname }} ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            <label for="fullName">{{ __('Panel-Lang::trans.LastName') }}</label>
                                                                            <input type="text" class="form-control mb-4" id="lname" name="lname" placeholder="{{ __('Panel-Lang::trans.LastName') }}" value="{{ $user->lname }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4" id="address" name="address" placeholder="{{ __('Panel-Lang::trans.Address') }}" value="{{ $user->address }}" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="location">{{ __('Panel-Lang::trans.Location') }}</label>
                                                        <input type="text" class="form-control mb-4" id="location" name="location" placeholder="{{ __('Panel-Lang::trans.Location') }}" value="{{ $user->location }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="phone">{{ __('Panel-Lang::trans.Phone') }}</label>
                                                        <input type="text" class="form-control mb-4" id="phone" name="phone" placeholder="{{ __('Panel-Lang::trans.Phone') }}" value="{{ $user->phone }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="email">{{ __('Panel-Lang::trans.Email') }}</label>
                                                        <input type="text" class="form-control mb-4" id="email" name="email" placeholder="{{ __('Panel-Lang::trans.Email') }}" value="{{ $user->email }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="website1">{{ __('Panel-Lang::trans.Website') }}</label>
                                                        <input type="text" class="form-control mb-4" id="website1" name="website" placeholder="{{ __('Panel-Lang::trans.Website') }}" value="{{ $user->website }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
