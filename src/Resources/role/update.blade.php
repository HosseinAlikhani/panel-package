                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form name="form" class="section role" method="PATCH" action="{{ route('patch.role', $role->id) }}">
                                @csrf
                                <div class="info">
                                    <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" id="RoleName" name="name" placeholder="{{ __('Panel-Lang::trans.RoleName') }}" value="{{ $role->name }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
