                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <form name="general-info" class="section general-info"
                                  method="POST" action="{{ route('post.setting') }}"
                            >
                                @csrf
                                <div class="info">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4" id="fname" name="fname" placeholder="{{ __('Panel-Lang::trans.FirstName') }}" value="{{ Auth::user()->fname }} ">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            <label for="fullName">{{ __('Panel-Lang::trans.LastName') }}</label>
                                                                            <input type="text" class="form-control mb-4" id="lname" name="lname" placeholder="{{ __('Panel-Lang::trans.LastName') }}" value="{{ Auth::user()->lname }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mb-4" id="address" name="address" placeholder="{{ __('Panel-Lang::trans.Address') }}" value="{{ Auth::user()->address }}" >
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="location">{{ __('Panel-Lang::trans.Location') }}</label>
                                                        <input type="text" class="form-control mb-4" id="location" name="location" placeholder="{{ __('Panel-Lang::trans.Location') }}" value="{{ Auth::user()->location }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="phone">{{ __('Panel-Lang::trans.Phone') }}</label>
                                                        <input type="text" class="form-control mb-4" id="phone" name="phone" placeholder="{{ __('Panel-Lang::trans.Phone') }}" value="{{ Auth::user()->phone }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="email">{{ __('Panel-Lang::trans.Email') }}</label>
                                                        <input type="text" class="form-control mb-4" id="email" name="email" placeholder="{{ __('Panel-Lang::trans.Email') }}" value="{{ Auth::user()->email }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="website1">{{ __('Panel-Lang::trans.Website') }}</label>
                                                        <input type="text" class="form-control mb-4" id="website1" name="website" placeholder="{{ __('Panel-Lang::trans.Website') }}" value="{{ Auth::user()->website }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 m-5">
                                            <button type="button" id="update-profile-setting" class="btn btn-success"> {{ __('Panel-Lang::trans.Update') }} </button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input-group social-linkedin mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="linkedin Username" aria-label="Username" aria-describedby="linkedin" value="{{ Auth::user()->linkedin }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group social-tweet mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Twitter Username" aria-label="Username" aria-describedby="tweet" value="{{ Auth::user()->tweet }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input-group social-fb mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Facebook Username" aria-label="Username" aria-describedby="fb" value="{{ Auth::user()->facebook }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group social-github mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Github Username" aria-label="Username" aria-describedby="github" value="{{ Auth::user()->github }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
