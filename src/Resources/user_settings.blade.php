...
@section('css')
    <link rel="stylesheet" type="text/css" href="/src/panel/plugins/dropify/dropify.min.css">
    <link href="/src/panel/assets/css/users/account-setting.css" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="/src/panel/plugins/dropify/dropify.min.js"></script>
    <script src="/src/panel/plugins/blockui/jquery.blockUI.min.js"></script>
    <!-- <script src="plugins/tagInput/tags-input.js"></script> -->
    <script src="/src/panel/assets/js/users/account-settings.js"></script>
@endsection
