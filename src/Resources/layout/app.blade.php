...
<head>
    ...
    <link href="{{ asset('/src/panel/assets/css/plugins.css') }}" rel="stylesheet" type="text/css" />
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index-2.html">
                        <img src="{{ asset('/src/panel/assets/img/logo.svg') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="/src/panel/assets/img/profile-17.jpg" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
                                    <h5>Sonia Shaw</h5>
                                    <p>Project Leader</p>
                                </div>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                <div class="profile-info">
                    ...
                    <div class="user-info">
                        <img src="/src/panel/assets/img/profile-17.jpg" alt="avatar">
...
<script src="{{ asset('/src/panel/assets/js/libs/jquery-3.1.1.min.js') }}"></script>
<script src="{{ asset('/src/panel/bootstrap/js/popper.min.js') }}"></script>
<script src="{{ asset('/src/panel/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('/src/panel/plugins/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
<script src="{{ asset('/src/panel/assets/js/app.js') }}"></script>
<script>
